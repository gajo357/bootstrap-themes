var themes = ["purple", "office-white", "blazing-berry", "online-pvt"];
...
var minifyCss = lazypipe().pipe(cleanCss).pipe(rename, { suffix: ".min" });
...
gulp.task(
  "watch",
  gulp.series("default", "connect", "attachHtml", "attachScss")
);
