...
(function () {
  ...
  themes["online-pvt"] = { folder: "online-pvt", title: "OnlinePVT" };
  ...
  function updateThemesList() {
    ...
    for (var themeName in themes) {
      listHtml +=
        "<a class='dropdown-item' href='javascript:;' onclick='dx.setTheme(&quot;" +
        themeName +
        "&quot;)'>" +
        themes[themeName].title +
        "</a>";
    }
